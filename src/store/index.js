...
export default new Vuex.Store({
  ...
  actions: {
    ...
    createBike({ state, commit }, newBike){
      axios.post('https://618515f123a2fe0017fff366.mockapi.io/bikes', newBike).then((response)=>{
    ...
    updateBike({ state }, bikeToUpdate){
      axios.put('https://618515f123a2fe0017fff366.mockapi.io/bikes/' + bikeToUpdate.id, bikeToUpdate).then((response)=>{
        console.log(response.data);
        console.log(state);
      })
    }
